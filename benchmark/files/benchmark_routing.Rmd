...
few_edges <- predped::compute_edges(setting, many_nodes = FALSE)
many_edges <- predped::compute_edges(setting, many_nodes = TRUE)
...
# Test
fn <- (\() predped::compute_edges(setting, many_nodes = FALSE)) |>
    test_times() |>
    rnd()

fl <- (\() predped::compute_edges(lim_setting, many_nodes = FALSE)) |>
    test_times() |>
    rnd()

mn <- (\() predped::compute_edges(setting, many_nodes = TRUE)) |>
    test_times() |>
    rnd()

ml <- (\() predped::compute_edges(lim_setting, many_nodes = TRUE)) |>
    test_times() |>
    rnd()
