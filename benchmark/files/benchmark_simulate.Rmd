...
```{r simulate simulate, echo = TRUE, results = "asis"}
...
set.seed(1)
np_m <- (\() predped::simulate(my_model, 
                               max_agents = 70, 
                               initial_agents = initial_condition$agents,
                               iterations = 10, 
...
set.seed(1)
np_f <- (\() predped::simulate(my_model, 
                               max_agents = 70, 
                               initial_agents = initial_condition$agents,
                               iterations = 10, 
                               precompute_edges = FALSE,
