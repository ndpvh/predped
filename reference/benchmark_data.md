...
This data.frame contains data of a long-corridor type of simulation,
letting several people walk from one end of a seemingly infinite
corridor to the other side. This is used to benchmark and evaluate some
of the functions related to data handling, as well as the likelihood
function.
...
A data frame with 1000 rows and 30 variables:
