...
The variable `trace` is a list containing instances of the [`state`](https://ndpvh.github.io/predped/reference/state) class. Essentially, this class contains all information about the agents, environment, and other variables that are relevant for the simulation at each iteration. It has the following (relevant) slots:
